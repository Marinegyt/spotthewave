    ...
    @markers = @spots.geocoded.map do |spot|
      {
        ...
        marker_html: current_user.bookmarks.map(&:spot).flatten.include?(spot) ? render_to_string(partial: "marker", locals: {spot: spot}) : render_to_string(partial: "marker_disabled", locals: {spot: spot})
      }
    end
